      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div className="flex flex-col items-center text-center p-6">
            ...
            <h3 className="font-semibold text-xl mb-2">Garantia de 12 Meses</h3>
            <p className="text-gray-300">Ou 15.000 km rodados, o que ocorrer primeiro</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center p-6">
            <div className="bg-[#FF6B00]/20 p-4 rounded-full mb-4">
              <ThumbsUp size={32} className="text-[#FF6B00]" />
            </div>
            <h3 className="font-semibold text-xl mb-2">Satisfação Garantida</h3>
            <p className="text-gray-300">Se não ficar satisfeito, devolvemos seu dinheiro</p>
          </div>
        </div>
